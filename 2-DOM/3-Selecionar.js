...
-Selecionando Elementos da Página
   ...
   *Por uma combinação de regras que descrevem a posição do elemento
   ...
   Entre todas as formas de seleção, a que mais é utilizada é o identificador (id), pois ela existe para ser única dentro de uma página, o que torna a busca mais simples e rápida. A unicidade irá garantir que não haverá ambiguidade na minipulação do elemento. 
...
!Uma NodeList não é um Array
   É possível transformar uma NodeList em Array quando se quer utlizar seus métodos, como pop(), map() e entre outros
*/
...
-Selecionando um atributo
   É possível selecionar um atributo dentro de uma tag, basta adicionar .getAttribute() após a variavel em que se guarda o querySelectorAll() ou escreve-lo logo em seguida. Vamos ver o exemplo abaixo
*/
