...
console.log("\n\tExemplo 1.2")
console.log(ex1.scrollHeight + " - Altura + Padding, mesmo dentro de scroll escondido")
console.log(ex1.scrollWidth + " - Largura + Padding, mesmo dentro de scroll escondido")
...
offsetTop e offsetLeft
   ...
   Quando você lê section.offsetTop, o navegador está dizendo quantos pixels a parte superior da <section> está afastada do topo do seu contêiner de referência. É como medir a distância do teto do prédio até o teto da sala. Se a seção estiver mais abaixo na página, esse número aumenta. Se estiver colada no topo do contêiner, esse valor é zero. Se nenhum pai tiver posicionamento (position:absolute e position:relative), o navegador usa o body como referência.
...
console.log(ex1.offsetHeight)
console.log(ex1.offsetWidth)
...
window.innner... e window.outer...
   As propriedades window.innerWidth, window.outerWidth, window.innerHeight e window.outerHeight existem justamente para separar aquilo que é o espaço útil onde o seu conteúdo vive daquilo que é apenas a moldura do navegador.

   window.innerWidth e window.innerHeight descrevem o tamanho real da viewport, ou seja, a área onde o HTML, o CSS e o Canvas são desenhados, se você redimensiona a janela, esses valores mudam imediatamente.

   Já window.outerWidth e window.outerHeight, eles medem a janela inteira do navegador, incluindo tudo o que não faz parte do conteúdo: bordas, barras de rolagem, barra de título, barra de endereço, abas e até as ferramentas de desenvolvedor quando estão abertas.
*/ 
console.log("\n\tExemplo 4")
